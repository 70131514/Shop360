...
const WelcomeBackScreen = ({ variant, onDone }: Props) => {
  ...
  // Background animations (same vibe as your welcome screen)
  ...
  const title = variant === 'back' ? `Welcome back, ${name}.` : `Welcome, ${name}.`;
  const subtitle =
    variant === 'back' ? 'Glad to see you again.' : 'Your profile is ready. Let’s get started.';
